  ...
  return {
    palette: {
      ...
      primary: {
        ...
        ...(mode === 'dark' && { contrastText: brand[50], light: brand[300], main: brand[400], dark: brand[700] }),
      },
      info: {
        light: brand[100], main: brand[300], dark: brand[600], contrastText: gray[50],
        ...(mode === 'dark' && { contrastText: brand[300], light: brand[500], main: brand[700], dark: brand[900] }),
      },
      warning: {
      ...
      grey: { ...gray },
      amber: {
        light: 'hsl(41, 98%, 65%)', main: 'hsl(41, 98%, 51%)', dark: 'hsl(41, 98%, 35%)', contrastText: gray[900],
        ...(mode === 'dark' && { light: 'hsl(41, 95%, 60%)', main: 'hsl(41, 98%, 51%)', dark: 'hsl(41, 95%, 40%)', contrastText: gray[900] }),
      },
      ...
      text: {
        primary: gray[800], secondary: gray[600], warning: orange[400],
        ...(mode === 'dark' && { primary: 'hsl(0, 0%, 100%)', secondary: gray[400] }),
      },
      action: {
        hover: alpha(gray[200], 0.2), selected: `${alpha(gray[200], 0.3)}`,
        ...(mode === 'dark' && { hover: alpha(gray[600], 0.2), selected: alpha(gray[600], 0.3) }),
      },
    },
  };
};
...
export const colorSchemes = {
  light: {
    palette: {
      ...
      background: { default: 'hsl(0, 0%, 99%)', paper: 'hsl(220, 35%, 97%)', panel: gray[75] },
      text: { primary: gray[800], secondary: gray[600], warning: orange[400] },
      action: { hover: alpha(gray[200], 0.2), selected: `${alpha(gray[200], 0.3)}` },
      amber: { light: 'hsl(41, 98%, 65%)', main: 'hsl(41, 98%, 51%)', dark: 'hsl(41, 98%, 35%)' },
  ...
  dark: {
    palette: {
      ...
      background: { default: gray[900], paper: 'hsl(220, 30%, 7%)', panel: gray[700] },
      text: { primary: 'hsl(0, 0%, 100%)', secondary: gray[400] },
      action: { hover: alpha(gray[600], 0.2), selected: alpha(gray[600], 0.3) },
      amber: { light: 'hsl(41, 95%, 60%)', main: 'hsl(41, 98%, 51%)', dark: 'hsl(41, 95%, 40%)' },
